...
class _StronaHistoriaZamWidgetState extends State<StronaHistoriaZamWidget> {
  ...
  Widget build(BuildContext context) {
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<OrderHistoryRecord>>(
        stream: queryOrderHistoryRecord(
          queryBuilder: (orderHistoryRecord) => orderHistoryRecord
              ...
              .where(
                'order_time',
                isGreaterThanOrEqualTo: _model.dataOd,
              )
              .where(
                'order_time',
                isLessThanOrEqualTo: _model.dataDo,
              )
        ...
        builder: (context, snapshot) {
          ...
          List<OrderHistoryRecord> stronaHistoriaZamOrderHistoryRecordList =
              snapshot.data!;
                                    ...
                                    Builder(
                                      builder: (context) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemCount: listaZamowien.length,
                                          itemBuilder:
                                              (context, listaZamowienIndex) {
                                            final listaZamowienItem =
                                                listaZamowien[
                                                    listaZamowienIndex];
