...
class MenuDodawaniaWidget extends StatefulWidget {
  const MenuDodawaniaWidget({
    super.key,
  ...
  @override
  State<MenuDodawaniaWidget> createState() => _MenuDodawaniaWidgetState();
}

class _MenuDodawaniaWidgetState extends State<MenuDodawaniaWidget> {
  late MenuDodawaniaModel _model;
                          ...
                          child: StreamBuilder<List<ProductsRecord>>(
                            stream: queryProductsRecord(
                              queryBuilder: (productsRecord) =>
                                ...
                                'category',
                                isEqualTo: FFAppState().wybranaKategoria != ''
