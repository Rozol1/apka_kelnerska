...
import 'opcje_filtrowania_widget.dart' show OpcjeFiltrowaniaWidget;
import 'package:flutter/material.dart';

class OpcjeFiltrowaniaModel extends FlutterFlowModel<OpcjeFiltrowaniaWidget> {
  ...
  // Stores action output result for [Custom Action - pobierzKategorieZbazy] action in OpcjeFiltrowania widget.
  List<String>? pobraneKategorie;
  // Stores action output result for [Custom Action - pobierzAlergenyZbazy] action in OpcjeFiltrowania widget.
