...
class ZmianaHaslaWidget extends StatefulWidget {
  ...
  static String routeName = 'zmiana_hasla';
  static String routePath = '/zmianaHasla';
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Ze względów bezpieczeństwa wymagane jest podanie aktualnego hasła oraz dwukrotne wprowadzenie nowego hasła.',
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Nowe hasło powinno zawierać co najmniej 8 znaków, w tym wielkie i małe litery, cyfry oraz znaki specjalne.',
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    font: GoogleFonts.inter(
