...
class DodajDoMenuWidget extends StatefulWidget {
  ...
  static String routeName = 'dodaj_do_menu';
  static String routePath = '/dodajDoMenu';

  @override
  State<DodajDoMenuWidget> createState() => _DodajDoMenuWidgetState();
}

class _DodajDoMenuWidgetState extends State<DodajDoMenuWidget> {
  late DodajDoMenuModel _model;
