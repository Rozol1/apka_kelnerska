...
class KodRestauracjiWidget extends StatefulWidget {
  const KodRestauracjiWidget({super.key});

  static String routeName = 'kod_restauracji';
  static String routePath = '/kodRestauracji';

  @override
  State<KodRestauracjiWidget> createState() => _KodRestauracjiWidgetState();
}

class _KodRestauracjiWidgetState extends State<KodRestauracjiWidget> {
  late KodRestauracjiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KodRestauracjiModel());
